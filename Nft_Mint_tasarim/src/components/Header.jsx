  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className='text-white text-2xl ml-2'>Mint DAPP</span>
      </div>

      <ul className='md:flex md:flex-[0.5] text-white hidden list-none
      ...
      <button className='shadow-xl shadow-black text-white
        bg-[#e32970] hover:bg-[#bd255f] md:text-xs 
